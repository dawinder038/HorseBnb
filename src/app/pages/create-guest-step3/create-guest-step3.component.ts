...
@Component({
  selector: 'app-create-guest-step3',
  templateUrl: './create-guest-step3.component.html',
  styleUrls: ['./create-guest-step3.component.scss']
})
export class CreateGuestStep3Component implements OnInit {
  counter:any=0;
  id:any;
...
addStalls(){
  ...
  this.service.ownListingUpdateApi(payload).subscribe((result:any)=>{
    ...
    setTimeout(() => {
      this.router.navigateByUrl('/create-guest/step5/'+this.id);
    }, 700);
  })
}
